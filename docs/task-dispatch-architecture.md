# 三省七部任务分发流转体系 · 业务与技术架构

> 本文档详细阐述「三省七部」项目如何从**业务制度设计**到**代码实现细节**，完整处理复杂多Agent协作的任务分发与流转。这是一个**制度化的AI多Agent框架**，而非传统的自由讨论式协作系统。
...
### CrewAI / AutoGen 的传统方式 vs 三省七部的制度化方式

| 维度 | CrewAI | AutoGen | **三省七部** |
|------|--------|---------|----------|
...
python3 scripts/kanban_update.py done \
  ...
  "三省七部协议文档已完成，包含89页，5个阶段历时3天，总消耗成本$2.34"
...
**三省七部是一个制度化的AI多Agent系统**，不是传统的"自由讨论"框架。它通过：
...
相比 CrewAI/AutoGen 的"自由+人工管理"，三省七部提供了一套**企业级的AI协作框架**。
