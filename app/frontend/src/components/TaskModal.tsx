      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div className="task-actions">
            ...
            {['Pending', 'Research', 'Strategy', 'Review', 'Execution', 'Doing'].includes(task.state) && (
          ...
          <div className="sched-section">
            <div className="sched-head">
              <span className="sched-title">🧭 系统调度</span>
            ...
            <div className="sched-grid">
              ...
              <div className="sched-kpi"><div className="k">升级级别</div><div className="v">{!sched?.escalationLevel ? '无' : sched.escalationLevel === 1 ? '衡枢' : '行枢'}</div></div>
...
function LiveActivitySection({
  ...
  const phaseColors: Record<string, string> = {
    '用户': '#eab308', '谋部': '#f97316', '策枢': '#3b82f6', '衡枢': '#8b5cf6',
    '行枢': '#10b981', '七部': '#06b6d4', '品部': '#ec4899', '财部': '#f59e0b',
    '安部': '#ef4444', '规部': '#6366f1', '技部': '#14b8a6', '人部': '#d946ef',
  };
